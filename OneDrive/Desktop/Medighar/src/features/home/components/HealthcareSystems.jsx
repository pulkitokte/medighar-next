...
const HEALTHCARE_SYSTEMS = [
  {
    name: 'Allopathy',
    description: 'Modern medicine focused on diagnosing and treating disease with evidence-based therapies.',
  ...
  {
    name: 'Ayurveda',
    description: 'An ancient Indian system that balances body, mind, and spirit through natural remedies.',
  ...
  {
    name: 'Homeopathy',
    description: 'A holistic approach that uses highly diluted natural substances to stimulate healing.',
  ...
  {
    name: 'Naturopathy',
    description: 'A nature-based approach that supports the body\u2019s own ability to heal itself.',
